  ...
  dashboardPage(
   ...
   dashboardSidebar(
    sidebarMenu(
        ...
        menuItem("Japan", icon=icon("flag"), tabName = "Japanese", startExpanded = FALSE,
        ...
        menuItem("Italy", icon=icon("flag"), tabName = "Italy", startExpanded = FALSE,
        ...
        menuItem("Portugal", icon=icon("flag"), tabname = "Portugal", startExpanded = FALSE,
        ...
        menuItem("Brazil", icon=icon("flag"), tabname = "Brazil", startExpanded = FALSE,
        ...
        menuItem("England", icon=icon("flag"), tabname = "England", startExpanded = FALSE,
        ...
        menuItem("Croatia", icon=icon("flag"), tabname = "Croatia", startExpanded = FALSE,
        ...
        menuItem("South Africa", icon=icon("flag"), tabname = "South Africa", startExpanded = FALSE,
          menuSubItem("Wine Description", icon=icon("glass"), tabName = "south"),
          menuSubItem("Vineyard Location", icon=icon("globe"), tabName = "sthwine")),
        menuItem("Egypt", icon=icon("flag"), tabname = "Egypt", startExpanded = FALSE,
        ...
        menuItem("USA", icon=icon("flag"), tabname = "USA", startExpanded = FALSE,
        ...
        menuItem("France", icon=icon("flag"), tabname = "France", startExpanded = FALSE,
